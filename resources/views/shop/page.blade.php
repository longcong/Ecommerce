                ...
                <div class="col-md-3 col-sm-6 c-margin-b-20">
                    <div class="c-content-product-2 c-bg-white c-border">
                        <div class="c-content-overlay">
                            ...
                            <div class="c-bg-img-center c-overlay-object" data-height="height" style="height: 230px; background-image: url({{ asset('main/base/img/content/shop2/101.jpg);"></d ') }}" ></div>
                        </div>
                        <div class="c-info">
                            <p class="c-title c-font-16 c-font-slim">Exclusive Watches</p>
                            <p class="c-price c-font-14 c-font-slim">$548 &nbsp;
                ...
                <div class="col-md-3 col-sm-6 c-margin-b-20">
                    <div class="c-content-product-2 c-bg-white c-border">
                        <div class="c-content-overlay">
                            ...
                            <div class="c-bg-img-center c-overlay-object" data-height="height" style="height: 230px; background-image: url({{ asset('main/base/img/content/shop2/100.jpg);"></d ') }}" ></div>
                        </div>
                        <div class="c-info">
                            <p class="c-title c-font-16 c-font-slim">Watches</p>
                            <p class="c-price c-font-14 c-font-slim">$548 &nbsp;
                ...
                <div class="col-md-3 col-sm-6 c-margin-b-20">
                    <div class="c-content-product-2 c-bg-white c-border">
                        <div class="c-content-overlay">
                            ...
                            <div class="c-bg-img-center c-overlay-object" data-height="height" style="height: 230px; background-image: url({{ asset('main/base/img/content/shop2/102.jpg);"></d ') }}" ></div>
                        </div>
                        <div class="c-info">
                            <p class="c-title c-font-16 c-font-slim">iMac, iPad & iPhone</p>
                            <p class="c-price c-font-14 c-font-slim">$548 &nbsp;
