...
<head>
    ...
    <!-- BEGIN THEME STYLES -->
	<link href="{{ asset('main/css/default/css/plugins.css') }} " rel="stylesheet" type="text/css"/>
	<link href="{{ asset('main/css/default/css/components.css') }}" id="style_components') }} " rel="stylesheet" type="text/css"/>
	<link href="{{ asset('main/css/default/css/themes/default.css') }}" rel="stylesheet" id="style_theme" type="text/css"/>
	<link href="{{ asset('main/css/default/css/custom.css') }} " rel="stylesheet" type="text/css"/>
	<!-- END THEME STYLES -->
		...
		<div class="col-md-3 col-sm-6 c-margin-b-20">
			<div class="c-content-product-2 c-bg-white c-border">
				<div class="c-content-overlay">
					...
					<div class="c-bg-img-center c-overlay-object" data-height="height" style="height: 230px; background-image: url({{ asset('main/base/img/content/shop2/100.jpg);"></d ') }}" >
				</div>
				<div class="c-info">
		...
		<div class="col-md-3 col-sm-6 c-margin-b-20">
			<div class="c-content-product-2 c-bg-white c-border">
				<div class="c-content-overlay">
					...
					<div class="c-bg-img-center c-overlay-object" data-height="height" style="height: 230px; background-image: url({{ asset('main/base/img/content/shop2/83.jpg') }}"></div> 
				</div>
				<div class="c-info">
		...
		<div class="col-md-3 col-sm-6 c-margin-b-20">
			<div class="c-content-product-2 c-bg-white c-border">
				<div class="c-content-overlay">
					...
					<div class="c-bg-img-center c-overlay-object" data-height="height" style="height: 230px; background-image: url({{ asset('main/base/img/content/shop2/95.jpg') }}"></div> 
				</div>
				<div class="c-info">
		...
		<div class="col-md-3 col-sm-6 c-margin-b-20">
			<div class="c-content-product-2 c-bg-white c-border">
				<div class="c-content-overlay">
					...
					<div class="c-bg-img-center c-overlay-object" data-height="height" style="height: 230px; background-image: url({{ asset('main/base/img/content/shop2/98.jpg') }}"></div> 
				</div>
				<div class="c-info">
					<p class="c-title c-font-16 c-font-slim">Smartphone & Handset</p>
					<p class="c-price c-font-14 c-font-slim">$548 &nbsp;
		...
		<div class="col-md-3 col-sm-6 c-margin-b-20">
			<div class="c-content-product-2 c-bg-white c-border">
				<div class="c-content-overlay">
					...
					<div class="c-bg-img-center c-overlay-object" data-height="height" style="height: 230px; background-image: url({{ asset('main/base/img/content/shop2/101.jpg);"></d ') }}" >
				</div>
				<div class="c-info">
		...
		<div class="col-md-3 col-sm-6 c-margin-b-20">
			<div class="c-content-product-2 c-bg-white c-border">
				<div class="c-content-overlay">
					...
					<div class="c-bg-img-center c-overlay-object" data-height="height" style="height: 230px; background-image: url({{ asset('main/base/img/content/shop2/93.jpg') }}"></div> 
				</div>
				<div class="c-info">
		...
		<div class="col-md-3 col-sm-6 c-margin-b-20">
			<div class="c-content-product-2 c-bg-white c-border">
				<div class="c-content-overlay">
					...
					<div class="c-bg-img-center c-overlay-object" data-height="height" style="height: 230px; background-image: url({{ asset('main/base/img/content/shop2/96.jpg') }}"></div> 
				</div>
				<div class="c-info">
					<p class="c-title c-font-16 c-font-slim">Watches</p>
					<p class="c-price c-font-14 c-font-slim">$548 &nbsp;
		...
		<div class="col-md-3 col-sm-6 c-margin-b-20">
			<div class="c-content-product-2 c-bg-white c-border">
				<div class="c-content-overlay">
					...
					<div class="c-bg-img-center c-overlay-object" data-height="height" style="height: 230px; background-image: url({{ asset('main/base/img/content/shop2/53.jpg') }}"></div> 
				</div>
				<div class="c-info">
		...
		<div class="col-md-3 col-sm-6 c-margin-b-20">
			<div class="c-content-product-2 c-bg-white c-border">
				<div class="c-content-overlay">
					...
					<div class="c-bg-img-center c-overlay-object" data-height="height" style="height: 230px; background-image: url({{ asset('main/base/img/content/shop2/102.jpg);"></d ') }}" >
				</div>
				<div class="c-info">
					<p class="c-title c-font-16 c-font-slim">iMac, iPad & iPhone</p>
					<p class="c-price c-font-14 c-font-slim">$548 &nbsp;
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="c-container">
						...
						<ul class="c-works">
							<li class="c-first"><a href="#"><img src="{{ asset('main/base/img/content/stock/015.jpg') }}"alt="" class="img-responsive"/></a></li>
							<li><a href="#"><img src="{{ asset('main/base/img/content/stock/012.jpg') }}" class="img-responsive" alt=""/></a></li>
							<li class="c-last"><a href="#"><img src="{{ asset('main/base/img/content/stock/12.jpg') }}"alt="" class="img-responsive"/></a></li>
						</ul>
						<ul class="c-works">
							<li class="c-first"><a href="#"><img src="{{ asset('main/base/img/content/stock/014.jpg') }}" class="img-responsive" alt=""/></a></li>
							<li><a href="#"><img src="{{ asset('main/base/img/content/stock/011.jpg') }}" class="img-responsive" alt=""/></a></li>
							<li class="c-last"><a href="#"><img src="{{ asset('main/base/img/content/stock/15.jpg') }}" class="img-responsive" alt=""/></a></li>
						</ul>
						<ul class="c-works">
							<li class="c-first"><a href="#"><img src="{{ asset('main/base/img/content/stock/015.jpg') }}" class="img-responsive" alt=""/></a></li>
							<li><a href="#"><img src="{{ asset('main/base/img/content/stock/013.jpg') }}" class="img-responsive" alt=""/></a></li>
							<li class="c-last"><a href="#"><img src="{{ asset('main/base/img/content/stock/13.jpg') }}" class="img-responsive" alt=""/></a></li>
						</ul>
				...
				<div class="col-md-6 col-sm-12 c-col">
					<p class="c-copyright c-font-grey">2015 &copy; JANGO
						...
						<ul class="list-unstyled list-inline pull-right">
							<li><img class="img-responsive" src="{{ asset('main/base/img/content/payments/light/1.png') }}" width="60" /></li>
							<li><img class="img-responsive" src="{{ asset('main/base/img/content/payments/light/2.png') }}" width="60" /></li>
							<li><img class="img-responsive" src="{{ asset('main/base/img/content/payments/light/22.png') }}"  width="60" /></li>
							<li><img class="img-responsive" src="{{ asset('main/base/img/content/payments/light/5.png') }}" width="60" /></li>
							<li><img class="img-responsive" src="{{ asset('main/base/img/content/payments/light/6.png') }}" width="60" /></li>
						</ul>
					</div>
							</div>
		</div>
...
<div class="c-layout-go2top">
    ...
    <!-- BEGIN: CORE PLUGINS -->
	<!--[if lt IE 9]>
	<script src="{{ asset('main/l/plugins/excanvas.min.js') }}" type="text/javascript" ></script> 
	<![endif]-->
	...
	<script src="{{ asset('main/js/bootstrap/js/bootstrap.min.js') }}"  type="text/javascript" ></script>
	...
	<!-- END: CORE PLUGINS -->
			...
			<script src="{{ asset('main/js/revo-slider/js/jquery.themepunch.tools.min.js') }}" type="text/javascript" ></script>
			<script src="{{ asset('main/js/revo-slider/js/jquery.themepunch.revolution.min.js') }}" type="text/javascript" ></script>
			<script src="{{ asset('main/js/revo-slider/js/extensions/revolution.extension.slideanims.min.js') }}" type="text/javascript" ></script>
			<script src="{{ asset('main/js/revo-slider/js/extensions/revolution.extension.layeranimation.min.js') }}" type="text/javascript" ></script>
			<script src="{{ asset('main/js/revo-slider/js/extensions/revolution.extension.navigation.min.js') }}" type="text/javascript" ></script>
			<script src="{{ asset('main/js/revo-slider/js/extensions/revolution.extension.video.min.js') }}" type="text/javascript" ></script>
			<script src="{{ asset('main/js/revo-slider/js/extensions/revolution.extension.parallax.min.js') }}" type="text/javascript" ></script>
			<script src="{{ asset('main/js/cubeportfolio/js/jquery.cubeportfolio.min.js') }}" type="text/javascript" ></script>
			<script src="{{ asset('main/js/owl-carousel/owl.carousel.min.js') }}" type="text/javascript" ></script>
			<script src="{{ asset('main/js/counterup/jquery.waypoints.min.js') }}" type="text/javascript" ></script>
			<script src="{{ asset('main/js/counterup/jquery.counterup.min.js') }}" type="text/javascript" ></script>
			<script src="{{ asset('main/js/fancybox/jquery.fancybox.pack.js') }}" type="text/javascript" ></script>
			<script src="{{ asset('main/js/smooth-scroll/jquery.smooth-scroll.js') }}" type="text/javascript" ></script>
			<script src="{{ asset('main/js/typed/typed.min.js') }}" type="text/javascript" ></script>
			<script src="{{ asset('main/js/slider-for-bootstrap/js/bootstrap-slider.js') }}" type="text/javascript" ></script>
			<script src="{{ asset('main/js/js-cookie/js.cookie.js') }}" type="text/javascript" ></script>
				<!-- END: LAYOUT PLUGINS -->
	
	<!-- BEGIN: THEME SCRIPTS -->
	<script src="{{ asset('main/js/components.js') }}" type="text/javascript" ></script>
	<script src="{{ asset('main/js/components-shop.js') }}" type="text/javascript" ></script>
	...
	<!-- END: THEME SCRIPTS -->
			...
			<!-- BEGIN: PAGE SCRIPTS -->
								<script src="{{ asset('main/js/isotope/isotope.pkgd.min.js') }}" type="text/javascript" ></script>
											<script src="{{ asset('main/js/isotope/imagesloaded.pkgd.min.js') }}" type="text/javascript" ></script>
											<script src="{{ asset('main/js/isotope/packery-mode.pkgd.min.js') }}" type="text/javascript" ></script>
											<script src="{{ asset('main/js/pages/isotope-grid.js') }}" type="text/javascript" ></script>
							<!-- END: PAGE SCRIPTS -->
