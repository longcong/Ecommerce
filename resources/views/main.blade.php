                ...
                <div class="c-navbar-wrapper clearfix">
                    <div class="c-brand c-pull-left">
                        <a href="index-2.html" class="c-logo">
                            <img src="main/base/img/layout/logos/logo-3.png" alt="JANGO" class="c-desktop-logo">
                            <img src="main/base/img/layout/logos/logo-3.png" alt="JANGO" class="c-desktop-logo-inverse">
                            <img src="main/base/img/layout/logos/logo-3.png" alt="JANGO" class="c-mobile-logo"> </a>
                            ...
                            <li class="c-menu-type-classic">
                                ...
                                <ul class="dropdown-menu c-menu-type-classic c-pull-left">
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu c-pull-right">
                                            <li>
                                                <a href="index38b5.html?p=footer-1#footer&d=default">Footer 1</a>
                                            </li>
                                            <li>
                                                <a href="index0a61.html?p=footer-2#footer&d=default">Footer 2</a>
                                            </li>
                                            <li>
                                                <a href="index07c1.html?p=footer-3#footer&d=default">Footer 3</a>
                                            </li>
                                            <li>
                                                <a href="index5ec5.html?p=footer-4#footer&d=default">Footer 4</a>
                                            </li>
                                            <li>
                                                <a href="index7290.html?p=footer-5#footer&d=default">Footer 5</a>
                                            </li>
                                            <li>
                                                <a href="index470e.html?p=footer-6#footer&d=default">Footer 6</a>
                                            </li>
                                            <li>
                                                <a href="indexc781.html?p=footer-7#footer&d=default">Footer 7</a>
                                            </li>
                                            <li>
                                                <a href="index18e9.html?p=footer-8#footer&d=default">Footer 8</a>
                                            </li>
                                            <li>
                                                <a href="indexf5e8.html?p=footer-9#footer&d=default">Footer 9</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="dropdown-submenu">
                                    ...
                                    <li class="dropdown-submenu">
                                        <a href="index766d.html?p=page-extended-portfolio">Multi Level Menu
                                            <span class="c-arrow c-toggler"></span>
                                        </a>
                                        <ul class="dropdown-menu c-pull-right">
                                            <li>
                    ...
                    <ul class="c-cart-menu-items">
                        <li>
                            <div class="c-cart-menu-close">
                                <a href="#" class="c-theme-link">x</a>
                            </div>
                            <img src="main/base/img/content/shop2/24.jpg" />
                        ...
                        <li>
                            ...
                            <img src="main/base/img/content/shop2/12.jpg" />
                            <div class="c-cart-menu-content">
                                <p>1 x
                                    <span class="c-item-price c-theme-font">$30</span>
                                </p>
