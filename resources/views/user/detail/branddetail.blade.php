...
@section('title' , "| $filter_brand->name")
...
<div class="c-layout-breadcrumbs-1 c-subtitle c-fonts-uppercase c-fonts-bold c-bordered c-bordered-both">
	<div class="container">
		<div class="c-page-title c-pull-left">
			...
			<h4 class="">{{ $filter_brand->meta_title }}</h4>
		</div>
		<ul class="c-page-breadcrumbs c-theme-nav c-pull-right c-fonts-regular">
			<li class="c-state_active">{{ $filter_brand->name }}</li>						
		</ul>
	</div>
	...
	<div class="c-content-product-2 c-bg-white">
            ...
            <div class="col-md-8">
                <div class="c-info-list">
                    ...
                    <p class="c-price c-font-26 c-font-thin">{{ number_format($post->price - $post->discount_value)}} VNĐ &nbsp;
                        <span class="c-font-26 c-font-line-through c-font-red">{{ number_format($post->price) }} VNĐ</span>
                    </p>
                </div>
                <div>
					@if($post->quantity>0)
