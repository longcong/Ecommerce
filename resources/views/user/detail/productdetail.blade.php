                ...
                <div class="item product_data">
                    ...
                    <div class="c-content-product-2 c-bg-white c-border">
                        <div class="c-content-overlay">
                            ...
                            <div class="c-bg-img-center-contain c-overlay-object" data-height="height" style="height: 270px; background-image: url({{ asset('images/' . $post->image) }}) ;"></div>
                        </div>
                        <div class="c-info">
                            <p class="c-title c-font-18 c-font-slim">{{ $post->title }}</p>
                            <p class="c-price c-font-16 c-font-slim">{{ $post->price - $post->discount_value }}$ &nbsp;
                                <span class="c-font-16 c-font-line-through c-font-red">{{ $post->price }}$</span>
                            </p>
                        </div>
