...
=> 'PUT']) !!}
<h1 class="edit catgory">Edit Brand</h1>
<hr>
<div class="card">
    <div class="card-body">
        <div class="row cate">
            <div class="col-md-8">
                <div class="row g-2 align-items-center">
                    <div class="col-2 ">
                        {{ Form::label('name', 'Name:', ['class' => 'margin-top']) }}
                    </div>
                    <div class="col-8">
                ...
                <div class="row g-2">
                    <div class="col-2 ">
                        {{ Form::label ('featured_image','Upload Logo Image:') }}
                    </div>
                    <div class="col-8">
            ...
            <div class="col-md-4">
                <div class="row action-cate">
                    ...
                    <!-- delete  -->
                    <div class="col-sm-4">
                        {!! Html::linkRoute('brands.index','Cancel', array($brands->id), array('class'=> 'btn
