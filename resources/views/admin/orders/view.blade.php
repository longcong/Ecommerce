        ...
        <div class="container">
            <div class="c-shop-order-complete-1 c-content-bar-1 c-align-left c-bordered c-theme-border c-shadow">
                ...
                <div class="row c-order-summary c-center">
                    <ul class="c-list-inline list-inline">
                        ...
                        <li>
                            ...
                            <p>{{ date('M j, Y h:ia', strtotime($orders->created_at)) }}
                            </p>
                        </li>
                        <li>
                            <h3>Total Payable</h3>
                ...
                <div class="c-bank-details c-margin-t-30 c-margin-b-30">
                    ...
                    <h3 class="c-border-bottom">Account Name : &nbsp;<span
                            class="c-font-thin">{{ $users->username }}</span></h3>
                    <ul class="c-list-inline list-inline">
                        <li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 col-sm-2">
                                    ...
                                    <p class="c-font-sbold c-font-uppercase c-font-18">
                                        {{ $item->products->discount_value }}</p>
                                </div>
                                <div class="col-md-2 col-sm-2">
                                ...
                                <div class="col-md-2 col-sm-2">
                                    ...
                                    <p class="c-font-sbold c-font-18">
                                        {{ ($item->price * $item->quantity)-($item->products->discount_value* $item->quantity) }}
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-sm-6 c-margin-t-20">
                        <div data-height="height">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li>Email: <a href="{{ $orders->email }}"
                                        class="c-theme-color">{{ $orders->email }}</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 c-margin-t-20">
